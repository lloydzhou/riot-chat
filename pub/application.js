...
},{"./tags/control-bar.tag":2,"./tags/message.tag":3,"./tags/viewport.tag":4,"riot":5}],2:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag2('control-bar', '<form id="msg" onsubmit="{send}"> <input type="text" name="message" autocomplete="off" class="u-full-width" placeholder="I\'m dangerous …"> <button name="submit" class="button-primary u-pull-right">Send</button> </form>', 'control-bar,[riot-tag="control-bar"] { display: block; position: fixed; bottom: 0; top: auto; width: auto; left: 0; right: 0; } control-bar form,[riot-tag="control-bar"] form { background: #FFF; margin-bottom: 0px; padding: 10px; }', '', function(opts) {
...
var riot = require('riot');
module.exports = riot.tag2('message', '<div class="{bubble: true, me: cls == \'me\', buddy: cls == \'buddy\', system: cls == \'system\', in: visible}">{content}</div>', 'message,[riot-tag="message"] { } message .bubble,[riot-tag="message"] .bubble{ border-radius: 5px; display: inline-block; padding: 10px 18px; position: relative; vertical-align: top; color: #999; background: #F0F0F0; clear: both; margin:10px; opacity:0.05; transition:visibility 0s linear 1s, opacity 430ms ease-in-out; } message .bubble.in,[riot-tag="message"] .bubble.in { transition-delay: 0ms; opacity:1; } message .bubble::before,[riot-tag="message"] .bubble::before { content: "\\00a0"; display: block; height: 16px; position: absolute; top: 11px; transform: rotate( 29deg ) skew( -35deg ); -moz-transform: rotate( 29deg ) skew( -35deg ); -ms-transform: rotate( 29deg ) skew( -35deg ); -o-transform: rotate( 29deg ) skew( -35deg ); -webkit-transform: rotate( 29deg ) skew( -35deg ); width: 20px; } message .bubble::after,[riot-tag="message"] .bubble::after { content: "\\00a0"; display: block; height:1px; position: relative; width: 100%; } message .bubble.system,[riot-tag="message"] .bubble.system { display: block; clear:both; width: 90%; } message .buddy,[riot-tag="message"] .buddy { background: #AEDB43; color: #333; float: left; margin: 5px 45px 5px 20px; } message .buddy::before,[riot-tag="message"] .buddy::before { background: #AEDB43; left: -9px; } message .me,[riot-tag="message"] .me { color: #555; background: #A0E3F8; float: right; margin: 5px 20px 5px 45px; } message .me::before,[riot-tag="message"] .me::before { background: #A0E3F8; right: -9px; }', '', function(opts) {
    var socket = opts.socket,
        $this = this;
      ...
      this.from = opts.message.from;
        setTimeout(function() {
          if ($this.from && $this.me && $this.from.id === $this.me.id) {
            var snd = new Audio("sound-send.mp3");
            snd.play();
          } else if ($this.from && $this.me && $this.from.id !== $this.me.id) {
            var snd = new Audio("sound-receive.mp3");
            snd.play();
          }
          $this.visible = true;
          $this.update();
...
var riot = require('riot');
module.exports = riot.tag2('viewport', '<div name="messages" class="messages"> <message each="{messageStack}" message="{this}" me="{parent.me} socket={opts.socket}"></message> </div>', 'viewport,[riot-tag="viewport"] { display: block; } viewport div.messages,[riot-tag="viewport"] div.messages { margin: 0; padding: 10px; position: fixed; top: 0; right: 0; left: 0; height: auto; width: auto; bottom:150px; overflow-x: hidden; overflow-y: auto; }', '', function(opts) {
    var socket = opts.socket,
        $this = this,
        $messages;
...
},{"riot":5}],5:[function(require,module,exports){
